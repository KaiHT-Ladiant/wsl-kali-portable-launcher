...
GitHub also shows contributors on the repository **Insights → Contributors** page based on merged commits. Commits authored with a verified GitHub-linked email are counted there.
